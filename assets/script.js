...
function getCurrent(city) {
  var requestUrlCurrent =
    "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=4cba12a73385abcc9d4e2c74697fadfa";
    console.log(requestUrlCurrent);
  fetch(requestUrlCurrent).then(function (response) {
...
// future weather conditions on page --> 5 day forecast (cards) with date, icon rep of weather conditions, temp, wind speed, humidity
